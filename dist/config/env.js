...
const envSchema = zod_1.z.object({
    ...
    APP_NAME: zod_1.z.string().default('School Management'),
    UPLOAD_DIR: zod_1.z.string().default('./uploads'),
    MAX_FILE_SIZE: zod_1.z.string().default('5242880').transform(Number),
    ALLOWED_FILE_TYPES: zod_1.z.string().default('jpg,jpeg,png,gif,pdf,docx,xlsx,csv,txt'),
    SUPER_ADMIN_JWT_SECRET: zod_1.z.string().min(32, 'SUPER_ADMIN_JWT_SECRET must be at least 32 characters').optional(),
