...
router.get('/class/:classId/summary', (0, validation_1.validateParams)(zod_1.z.object({ classId: common_1.IdSchema })), (0, validation_1.validateQuery)(zod_1.z.object({
    startDate: zod_1.z.string().regex(/^\d{4}-\d{2}-\d{2}$/).optional(),
    endDate: zod_1.z.string().regex(/^\d{4}-\d{2}-\d{2}$/).optional(),
})), attendanceController_1.getClassAttendanceSummary);
