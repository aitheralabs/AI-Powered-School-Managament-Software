...
class EmailService {
    ...
    async sendEmailVerification(to, schoolName, verifyUrl) {
    ...
    async sendSchoolWelcomeEmail(to, adminName, schoolName, trialDays = 30) {
    ...
    async sendTrialExpiryEmail(to, schoolName, daysLeft) {
        const appUrl = process.env.APP_URL || 'http://localhost:4200';
        const appName = process.env.APP_NAME || 'EduSaaS';
    ...
    async sendPaymentFailedEmail(to, schoolName, amount, currency = 'INR') {
        const appUrl = process.env.APP_URL || 'http://localhost:4200';
        const appName = process.env.APP_NAME || 'EduSaaS';
